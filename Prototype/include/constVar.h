...
#define INDEX_BACKUP 1

// for GC
#define IS_MERGE_CONTAINER 0
...
// Extension 离线优化相关配置
#define EXTENSION_ENABLE 1                           // 启用Extension功能
#define EXTENSION_FEATURE_THRESHOLD 100              // 特征数量阈值
#define EXTENSION_MIN_GROUP_SIZE 3                   // 最小组大小阈值
#define EXTENSION_SAMPLE_RATIO 0x0000400303410000ULL // 特征采样比率掩码
