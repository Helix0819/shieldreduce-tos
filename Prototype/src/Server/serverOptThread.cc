...
void ServerOptThread::Run(SSL *clientSSL)
{
    ...
    if (optType == OFFLINE_OPT)
    {
        ...
        // tool::Logging(myName_.c_str(), "Process Offline end2\n");
    }
    ...
    // tool::Logging(myName_.c_str(), "Process Offline end3\n");
#endif
    ...
    // tool::Logging(myName_.c_str(), "Process Offline end4\n");
    // print the info
