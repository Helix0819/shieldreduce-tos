...
void Ecall_GetEnclaveInfo(EnclaveInfo_t *info)
{
    ...
    info->dataTranTime = (enclaveBaseObj_->_dataTransTime -
                          (enclaveBaseObj_->_dataTransCount * rawOcallTime)) /
                         MS_TO_USEC;
    info->fpTime = (enclaveBaseObj_->_fingerprintTime -
                    (enclaveBaseObj_->_fingerprintCount * rawOcallTime)) /
                   MS_TO_USEC;
    info->freqTime = (enclaveBaseObj_->_freqTime -
                      (enclaveBaseObj_->_freqCount * rawOcallTime)) /
                     MS_TO_USEC;
    info->firstDedupTime = (enclaveBaseObj_->_firstDedupTime -
                            (enclaveBaseObj_->_firstDedupCount * rawOcallTime)) /
                           MS_TO_USEC;
    info->secondDedupTime = (enclaveBaseObj_->_secondDedupTime -
                             (enclaveBaseObj_->_secondDedupCount * rawOcallTime)) /
                            MS_TO_USEC;
    info->lz4compressTime = (enclaveBaseObj_->_lz4compressTime -
                             (enclaveBaseObj_->_lz4compressCount * rawOcallTime)) /
                            MS_TO_USEC;
    info->encTime = (enclaveBaseObj_->_encryptTime -
                     (enclaveBaseObj_->_encryptCount * rawOcallTime)) /
                    MS_TO_USEC;

    info->sfTime = (enclaveBaseObj_->_superfeatureTime -
                    (enclaveBaseObj_->_superfeatureCount * rawOcallTime)) /
                   MS_TO_USEC;

    info->checkTime = (enclaveBaseObj_->_localcheckerTime -
                       (enclaveBaseObj_->_localcheckerCount * rawOcallTime)) /
                      MS_TO_USEC;

    info->deltacompressTime = (enclaveBaseObj_->_deltacompressTime -
                               (enclaveBaseObj_->_deltacompressCount * rawOcallTime)) /
                              MS_TO_USEC;
    ...
    info->compTime = (enclaveBaseObj_->_compressTime -
                      (enclaveBaseObj_->_compressCount * rawOcallTime)) /
                     MS_TO_USEC;
    info->encTime = (enclaveBaseObj_->_encryptTime -
                     (enclaveBaseObj_->_encryptCount * rawOcallTime)) /
                    MS_TO_USEC;
